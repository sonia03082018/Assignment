...
const AddEmployee = () => {
    ...
    const {loading, error, success} = useSelector((state:RootState) => state.employees)
        ...
        <>
            <div className="flex min-h-full flex-col justify-center px-6  lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Add Employee</h2>
                </div>
